...
public class UploadableStorageEncoder implements Encoder {
    ...
    public List<Object> encode(ByteBufAllocator alloc) {
        ...
        byte cmd = FastDFSUtils.isEmpty(group) ? FastDFSConsts.Commands.SERVICE_QUERY_STORE_WITHOUT_GROUP_ONE : FastDFSConsts.Commands.SERVICE_QUERY_STORE_WITH_GROUP_ONE;
